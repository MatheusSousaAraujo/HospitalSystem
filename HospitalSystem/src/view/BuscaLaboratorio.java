 ...
 * @author house
 */
public class BuscaLaboratorio extends javax.swing.JDialog {

    /**
     * Creates new form ModeloBuscas_2024
     
     */
    public BuscaLaboratorio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo1.setText("Lista de Laboratórios");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Razão Social", "Contato", "Proprietário"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscaLaboratorio dialog = new BuscaLaboratorio(new javax.swing.JFrame(), true);
