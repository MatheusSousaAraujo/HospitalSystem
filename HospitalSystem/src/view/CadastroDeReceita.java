 ...
 * @author professor
 */
public class CadastroDeReceita extends javax.swing.JDialog {

    /**
     * Creates new form ModeloCadastral_2024
     */
    public CadastroDeReceita(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dara da Receita :");
        ...
        jLabel3.setText("Hora da Receita :");

        jFormattedTextField3.setText("14:32h");
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Clock.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroDeReceita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroDeReceita dialog = new CadastroDeReceita(new javax.swing.JFrame(), true);
