 ...
 * @author house
 */
public class BuscaFarmaceutico extends javax.swing.JDialog {

    /**
     * Creates new form ModeloBuscas_2024
     
     */
    public BuscaFarmaceutico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo1.setText("Lista de Farmaceuticos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaFarmaceutico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscaFarmaceutico dialog = new BuscaFarmaceutico(new javax.swing.JFrame(), true);
